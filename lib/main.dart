    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        appBarTheme: AppBarTheme(
          backgroundColor: Color(int.parse('#2196f3'.replaceFirst('#', '0xFF'))),
...
class _WebViewScreenState extends State<WebViewScreen> {
  ...
  String _currentUrl = 'https://tcgai.pro/';
  ...
  void _initializeWebView() {
    _controller = WebViewController()
      ..setJavaScriptMode(true ? JavaScriptMode.unrestricted : JavaScriptMode.disabled)
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onPageFinished: (String url) {
            ...
            _controller.runJavaScript('''
              (function() {
                ...
                meta.name = 'viewport';
                meta.content = 'width=device-width, initial-scale=1.0, maximum-scale=true ? 5.0 : 1.0, user-scalable=true ? yes : no';
          ...
          onNavigationRequest: (NavigationRequest request) {
            ...
            if (request.url.startsWith('https://tcgai.pro/')) {
      ...
      ..loadRequest(Uri.parse('https://tcgai.pro/'));
  }
                  ...
                  children: [
                    CircularProgressIndicator(
                      valueColor: AlwaysStoppedAnimation<Color>(
                        Color(int.parse('#2196f3'.replaceFirst('#', '0xFF'))),
                      ),
                    ),
                    SizedBox(height: 16),
                    Text(
